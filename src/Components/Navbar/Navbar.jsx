                                    ...
                                    <ul className='space-y-2'>
                                        {
                                            DropdownLinks.map((data, index) => {
                                                return(
                                                    <li>
                                                        <a className='text-gray-500 rounded-md font-semibold dark:hover:text-white duration-200 p-2 inline-block hover:bg-primary/20 w-full' href={data.link}>{data.name}</a>
                                                    </li>
                                                )
                                            })
                                        }
